...
produce = (produce.transpose())
#Question 1
print('1. Min and Max of Total Sale')
print(produce['Total Sale'].agg(['min','max']))
#Question 2 
print('2. Orange and Beets Quantity and Total Sold')
print(produce.loc[['Orange','Beets'],'Quantity Sold':'Total Sale'])
#Question 3 
print('3. Apples through Lettuce')
print(produce.loc['Apples':'Lettuce'])
#Question 4 
produce.at['Quantity Sold','Apricots'] = 11955
produce.at['Total Sale','Apricots']= 44353.05
print('4. Update Apricots')
print(produce.loc['Apricots'])
#Question 5 
print('5. Average of Quantity Sold')
print(produce.loc['Quantity Sold'].mean())
#Question 6 
produce1 = produce[(produce['Quantity Sold'] >= 11500) & (produce['Quantity Sold'] <= 12000)]
print('6. New frame with quantity between 11500 and 12000')
print(produce1['Quantity Sold'])
#Question 7 
print('7. Toatal Sum')
print (produce1['Total Sale'].sum())
